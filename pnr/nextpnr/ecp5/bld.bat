...
cmake -DBUILD_GUI=OFF -DTRELLIS_ROOT="%BASH_PREFIX%" -DPYTRELLIS_LIBDIR="%BASH_PREFIX%/lib/trellis" -DARCH=ecp5 -DCMAKE_TOOLCHAIN_FILE=vcpkg/scripts/buildsystems/vcpkg.cmake -DVCPKG_TARGET_TRIPLET=x64-windows-static -DBUILD_SHARED=OFF -DSTATIC_BUILD=ON "-DCMAKE_INSTALL_PREFIX=%BASH_PREFIX%" .
if errorlevel 1 exit 1
